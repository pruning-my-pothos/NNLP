...
mkdir -p "$DOCS_DIR/01-handbook-core-method"
mkdir -p "$DOCS_DIR/02-execution-patterns"
mkdir -p "$DOCS_DIR/03-professional-scenarios"
mkdir -p "$DOCS_DIR/04-responsible-ai"
mkdir -p "$DOCS_DIR/05-tooling-and-frameworks"
...
mv "$DOCS_DIR"/06-genai-project-lifecycle-and-method/* "$DOCS_DIR/01-handbook-core-method/"
...
mv "$DOCS_DIR"/07-responsible-ai-and-governance/* "$DOCS_DIR/04-responsible-ai/"
mv "$DOCS_DIR"/06-frameworks-and-tooling/* "$DOCS_DIR/05-tooling-and-frameworks/"
