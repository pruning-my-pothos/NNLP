...
| :------------------------------------ | :---------------------------------------- |
| Learning how to apply GenAI & LLM Handbook to your specific role | You are looking for a authoritative, single answer to every problem |
...
-   **Greenfield React Component**: Building a new, reusable UI component from scratch.
    -   `docs/03-professional-scenarios/01-greenfield-react-component.md`
-   **Refactoring Legacy Auth**: Safely modernizing a critical, high-risk authentication system.
    -   `docs/03-professional-scenarios/02-refactoring-legacy-auth.md`
-   **Feature Addition**: Incrementally adding a new feature to an existing codebase.
    -   `docs/03-professional-scenarios/engineering/02-feature-addition.md`
-   **Bug Triage and Fix**: Systematically diagnosing and resolving a software defect.
    -   `docs/03-professional-scenarios/engineering/03-bug-triage-and-fix.md`
-   **Legacy Refactor**: Tackling large-scale refactoring of an old codebase.
    -   `docs/03-professional-scenarios/engineering/04-legacy-refactor.md`
-   **Performance Investigation**: Using AI to identify and optimize performance bottlenecks.
    -   `docs/03-professional-scenarios/engineering/05-performance-investigation.md`
