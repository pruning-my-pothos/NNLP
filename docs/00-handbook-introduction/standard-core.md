---
title: "Standard Core (The GenAI & LLM Handbook)"
archetype: "standard"
status: "active"
owner: "Shailesh (Shaily)"
maintainer: "Shailesh (Shaily)"
version: "0.1.0"
tags: ["genai-llm", "standard", "navigation", "core"]
...
```mermaid
graph LR
    A[What is GenAI & LLM?] --> B[Scope & Applicability]
    B --> C[Prerequisites]
    C --> D[Accountability & Delegation]
    D --> E[Process Model]
    E --> F[Artifact Contracts]

    classDef core-doc fill:#E6F7FF,stroke:#1B75BB,color:#0F1F2E;
    class A,B,C,D,E,F core-doc;
```
