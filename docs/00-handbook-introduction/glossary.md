...
| **GenAI & LLM Handbook Loop**              | The execution rhythm from discovery through iteration.                                                                                                                                                                                                                                                    | `../01-handbook-core-method/the-genai-llm-loop.md`                                        |
| **Discovery Brief**                             | Short artifact capturing problem, context, and success markers without prescribing solutions.                                                                                                                                                                                                               | `../01-handbook-core-method/01-discovery-brief.md`                                      |
| **Intent Spec**                                 | Statement of goals and desired outcomes, independent of implementation.                                                                                                                                                                                                                                     | `../01-handbook-core-method/02-intent-spec.md`                                          |
| **Constraint Spec**                             | Non-negotiables, trade-offs, and guardrails the solution must honor.                                                                                                                                                                                                                                      | `../01-handbook-core-method/03-constraint-spec.md`                                      |
| **Delegation Contract**                         | Explicit permissions and prohibitions for AI assistance.                                                                                                                                                                                                                                                  | `../01-handbook-core-method/04-delegation-contract.md`                                  |
| **Generation Request**                          | Structured ask to an AI system, scoped by prior artifacts.                                                                                                                                                                                                                                                | `../01-handbook-core-method/05-generation-requests.md`                                  |
| **Review & Interrogation**                      | Systematic verification that outputs match intent, constraints, and acceptance criteria.                                                                                                                                                                                                                  | `../01-handbook-core-method/06-review-and-interrogation.md`                             |
| **Acceptance Criteria**                         | Observable conditions that define “done.”                                                                                                                                                                                                                                                                 | `../01-handbook-core-method/07-acceptance-criteria.md`                                  |
| **Artifact**                                    | A concrete, reviewable output from a stage of the GenAI & LLM Handbook Loop (e.g., spec, plan, code, test, documentation).                                                                                                                                                                    | `../01-handbook-core-method/artifact-contracts.md`                                   |
