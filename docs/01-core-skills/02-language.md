...
version: "0.1.0"
tags: ["nnlp", "language", "specification", "clarity", "ambiguity", "genai"]
...
:::info[Core idea]
In NNLP, language is a specification medium. Ambiguity is a defect, not a style choice.
:::
...
In NNLP, language is not a communication aid.
...
## What Language Means in NNLP

Language in NNLP is **deliberate and constrained**.
...
NNLP assumes **every unclear phrase is a potential defect**.
...
## Core Language Principles in NNLP
...
## Language Across the NNLP Method
...
## How to Practice Language in NNLP
...
Proceed to:
**`docs/01-core-skills/03-systems.md`**
