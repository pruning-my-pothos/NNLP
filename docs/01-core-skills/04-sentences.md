...
version: "0.1.0"
tags:
  ["nnlp", "sentences", "precision", "constraints", "interpretation", "genai"]
...
In NNLP, **sentences are executable units**.
...
## What “Sentences” Means in NNLP

Sentences in NNLP are not stylistic choices.
...
NNLP treats sentence construction as a technical skill.
...
## Common Sentence Patterns in NNLP
...
## Sentences Across the NNLP Method
...
- map behavior back to specific sentences
- identify which sentence allowed undesired behavior
- fix the sentence before regenerating

Never “fight” the output without fixing the sentence.
...
Sentence discipline is the fastest NNLP skill to improve.

---

## Core Skills Recap

You have now covered all four NNLP core skills:
...
Together, they form the human capability layer that makes NNLP reliable.
