...
version: "0.1.0"
tags: ["nnlp", "skill-matrix", "progression", "professional-growth"]
...
NNLP skills do not arrive fully formed.
They **progress through identifiable stages**.

This document provides:

- a skill matrix for NNLP
...
Skipping steps leads to fragile NNLP usage.
...
Proceed to:
**`docs/01-core-skills/06-common-skill-gaps.md`**
