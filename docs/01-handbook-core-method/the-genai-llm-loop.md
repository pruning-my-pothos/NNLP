...
-   Method backbone: `docs/01-handbook-core-method/`

1.  `docs/01-handbook-core-method/01-discovery-brief.md`
2.  `docs/01-handbook-core-method/02-intent-spec.md`
3.  `docs/01-handbook-core-method/03-constraint-spec.md`
4.  `docs/01-handbook-core-method/04-delegation-contract.md`
5.  `docs/01-handbook-core-method/05-generation-requests.md`
6.  `docs/01-handbook-core-method/06-review-and-interrogation.md`
7.  `docs/01-handbook-core-method/07-acceptance-criteria.md`
8.  `docs/01-handbook-core-method/08-iteration-and-release.md`
9.  `docs/01-handbook-core-method/09-working-agreements-for-teams.md`
