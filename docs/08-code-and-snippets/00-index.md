...
- **13-resource-and-performance**: Memory/CPU/disk/GPU checks, tokens/sec, OOM playbook, latency profiling.
- **14-logging-and-tracing**: Prompt/output logging, token/latency logging, run metadata, PII redaction basics.
- **15-safety-and-privacy**: Safety system starters, injection defense, local-first data, secrets/env hygiene, consent checks.
- **16-local-api-patterns**: OpenAI-compatible servers, curl chat/completions, Python/Node clients, streaming.
- **17-agents-and-tool-use-mini**: Single/multi-tool patterns, stop conditions/budgets, schemas/contracts, sandboxing.
- **18-batch-and-automation**: Run over folders, CSV batch, cron, parallelism, caching.
- **19-troubleshooting-cheatsheet**: Common fixes, networking, SSL/certs, encoding, dependency hell.
- **20-templates**: Project skeletons (Python/Node), runbook, eval report, config examples.

## Next Step

Start with [Setup & Installs](/docs/08-code-and-snippets/01-setup-and-installs/).
