...
version: "0.1.0"
tags: ["nnlp", "evaluation", "scorecard", "scenarios", "metrics"]
...
:::info[Purpose]
A Scenario Scorecard evaluates the **entire lifecycle** of an AI-assisted task. It answers: "Did the NNLP process actually work, or did we just generate code fast?"
:::
...
1. **Process Discipline**: Did we follow the NNLP Loop?
...
- **Training**: To grade practitioners on their NNLP adherence.
